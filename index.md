...
Each fusion is rendered as a multi-panel page showing: - Chromosome
ideograms with breakpoint positions - Exon structure with intron
squishing - Circos plot for genomic context - Retained protein domains
in the fusion transcript - Supporting read counts and assembly scores
...
[`tst/report.pdf`](https://bczech.github.io/BRASSVis/tst/report.pdf).

## Exported functions

| Function | Description |
|----|----|
| [`read_brass()`](https://bczech.github.io/BRASSVis/reference/read_brass.md) | Parse BRASS BEDPE file |
| [`load_annotations()`](https://bczech.github.io/BRASSVis/reference/load_annotations.md) | Load GTF, cytobands, and protein domains |
| [`plot_fusion()`](https://bczech.github.io/BRASSVis/reference/plot_fusion.md) | Visualize a single fusion event |
| [`brass_report()`](https://bczech.github.io/BRASSVis/reference/brass_report.md) | Generate a complete multi-page PDF report |
